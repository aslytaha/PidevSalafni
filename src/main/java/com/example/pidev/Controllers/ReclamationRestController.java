...
import com.example.pidev.Interfaces.IReclamationService;
import com.example.pidev.Repositories.ForBiddenWordRepository;
...
public class ReclamationRestController {
    ...
    public ResponseEntity<String> updateStatus(@PathVariable("reclamation_id") int id, @RequestBody String status) {
        ...
        if (reclamation != null) {
            ...
            if (updatedReclamation.getStatus() == StatusTransaction.EN_ATTENTE && status.equals("en_cours")) {
                updatedReclamation.setStatus(StatusTransaction.EN_COURS);
    ...
    public void sendReminderEmails() {
        List<Reclamation> reclamations = iReclamationService.findByStatus(StatusTransaction.EN_ATTENTE); // récupérer les réclamations en attente
    ...
    public ResponseEntity<String> updateStatusToEnCours(@PathVariable("reclamation_id") int id) {
        ...
        if (reclamation != null) {
            Reclamation updatedReclamation = reclamation;
            if (updatedReclamation.getStatus() == StatusTransaction.EN_ATTENTE) {
                updatedReclamation.setStatus(StatusTransaction.EN_COURS);
                iReclamationService.edit(updatedReclamation);
