...
import com.example.pidev.Repositories.ReclamationRepository;
...
import static com.example.pidev.Controllers.ReclamationRestController.getEmotionalState;
...
public class ReclamationService implements IReclamationService {
    ...
    @Override
    public List<Reclamation> findByStatus(StatusTransaction status) {
